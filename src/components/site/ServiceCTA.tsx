...
export default function ServiceCTA() {
  return (
    <aside className="mt-14 rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
      <p className="text-xs font-semibold tracking-[0.04em] text-teal-400">
        Need help with this?
      </p>
      ...
      <p className="mt-2 text-sm leading-7 text-zinc-400">
        If you are working on deployment, infrastructure, APIs or cloud architecture, I may be able to help.
      </p>
      <TrackedLink
        href="/work-with-me"
