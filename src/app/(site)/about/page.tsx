...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="container-shell">
          <div className="grid items-start gap-12 lg:grid-cols-[0.72fr_1.28fr]">
            ...
            <div>
              ...
              <h1 className="page-title">I connect software decisions to the infrastructure and operating model around them.</h1>
              <div className="mt-7 space-y-5 text-base leading-8 text-zinc-400">
                <p>
                  I am Cobbina Emmanuel, a Software & Cloud Engineer based in Accra, Ghana. My work spans backend APIs, full-stack products, AWS services, container platforms, delivery automation, data systems, and technical documentation.
                </p>
                <p>
      ...
      <section className="section-space border-t border-white/10 bg-zinc-900/30">
        <div className="container-shell">
          <SectionHeading
            ...
            title="Experience built across delivery, operations, and knowledge work."
            description="Roles and responsibilities are updated from my current CV."
          />
          <div className="relative mt-12 space-y-5 before:absolute before:bottom-2 before:left-[17px] before:top-2 before:w-px before:bg-white/10">
            {experience.map((item) => (
              <article className="relative grid gap-5 pl-12 md:grid-cols-[0.34fr_0.66fr]" key={`${item.role}-${item.organization}`}>
                ...
                <div className="py-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.14em] text-zinc-500">{item.period}</p>
      ...
      <section className="section-space border-t border-white/10 bg-zinc-900/30">
        <div className="container-shell">
          <SectionHeading eyebrow="Technical profile" title="The tools and practices I use to deliver." />
