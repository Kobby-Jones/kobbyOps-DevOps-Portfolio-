  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-950 p-6 text-zinc-100">
      <div className="surface-card max-w-xl p-10 text-center md:p-14">
        <p className="font-mono text-sm font-semibold uppercase tracking-[0.2em] text-teal-400">404 · Not found</p>
        <h1 className="mt-5 text-3xl font-semibold tracking-tight text-white md:text-4xl">This route does not lead to a published page.</h1>
